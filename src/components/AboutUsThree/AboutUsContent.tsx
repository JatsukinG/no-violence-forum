          ...
          <div className="row h-100 align-items-center">
            ...
            <div className="col-lg-6">
              <div className="about-content">
                ...
                <p>
                  El VIII FORO INTERNACIONAL DE NOVIOLENCIA es un espacio de encuentro de procesos sociales y académicos,
                  nacionales e internacionales que en la actualidad estén construyendo alternativas sobre
                  La Salud Mental Comunitaria.
                </p>
                <h6>
                  Este evento se lleva a cabo cada dos años y constituye una apuesta ética y política por la vida y la dignidad.
                </h6>
                <p>
                  El programa Trabajo Social de la Universidad del Quindío, conjuntamente con otras organizaciones amigas,
                  realiza desde 2009, el Foro Internacional de Noviolencia, siempre relativo a temáticas diversas como
          ...
          <div className="row h-100 align-items-center">
            ...
            <div className="col-lg-6">
              <div className="about-content">
                ...
                <p>
                  En la presente edición, asumimos el reto de visibilizar experiencias de salud mental comunitaria para
                  crear geografías de la esperanza, compuesta por iniciativas individuales y colectivas que construyen
                  alternativas en los ámbitos nacional e internacional. Estas experiencias, profundamente inspiradoras y
                  transformadoras, estarán presentes en nuestro evento para ser compartidas y tejidas con otros procesos en
                  favor de la convivencia y la salud mental y emocional.
                </p>
                <p>
                  <strong>La salud mental comunitaria*</strong> Se refiere a las estrategias autónomas desarrolladas por las comunidades para
                  ...
                  especializados y critican el paradigma capitalista e individualista, que excluye a muchos al exigir que
                  cada persona resuelva sus problemas emocionales por sí misma. En cambio, la salud mental comunitaria
                  promueve soluciones colectivas, basadas en el apoyo mutuo y la participación activa, reconociendo la
                  salud mental como un derecho humano y una responsabilidad compartida. Este enfoque se fundamenta en
                  prácticas que fortalecen las redes de apoyo, crean espacios de diálogo y fomentan actividades colectivas
            ...
            <p>
                El <strong>Foro Internacional de Noviolencia</strong> busca crear un espacio significativo que fortalezca y visibilice las 
                iniciativas comunitarias de salud mental. Nos proponemos facilitar un diálogo activo y acciones concretas 
                que promuevan la colaboración entre diversos actores. A través de dinámicas que faciliten la retroalimentación 
                y el tejido de sinergias, aspiramos a aportar a la construcción de "geografías de la esperanza". Estas, 
                serán mapas vivos de experiencias inspiradoras que motiven acciones reflexivas y colaborativas, en favor 
